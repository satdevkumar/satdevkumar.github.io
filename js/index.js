function basicInfo() {
    $.ajax({
        url: "data/basic.json", success: function (result) {
            var info = result;
...
function languages() {
    $.ajax({
        url: "data/languages.json", success: function (result) {
            var info = result;
...
function hobbies() {
    $.ajax({
        url: "data/hobbies.json", success: function (result) {
            var info = result;
            $(".languages-placeholder").remove();
            for (var i = 0; i < info.length; i++) {
                var value = '<div class="w3-light-grey w3-round-xlarge w3-small w3-margin-bottom">' +
...
function projects() {
    $.ajax({
        url: "data/projects.json", success: function (result) {
            var project = result;
            $(".work-placeholder").remove();
...
function educationInfo() {
    $.ajax({
        url: "data/education.json", success: function (result) {
            var info = result;
...
function socialMedias() {
    $.ajax({
        url: "data/social.json", success: function (result) {
            var info = result;
...
function siteInfo(name, image) {
    document.title = name + " : Satdev Kumar Updated CV";
